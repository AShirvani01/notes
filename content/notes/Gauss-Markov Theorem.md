...
---
---
The Gauss-Markov theorem proves that the OLS estimator is the Best Linear Unbiased Estimator (BLUE).
...
>&= ((\mathbf{X}^T\mathbf{X})^{-1} \mathbf{X}^T + \mathbf{D}) \mathbf{X} \boldsymbol\beta && E[\boldsymbol\epsilon] = 0\\
